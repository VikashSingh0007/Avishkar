          ...
          >
            <div className="relative w-full h-60 md:w-60 md:h-60">
              <img
                src={Culrav}
                alt="Avishkar"
                className="w-70% h-70% object-cover rounded-lg hover:scale-125 transition duration-300 ease-in-out"
              />
            </div>
          </Link>
          <Link
            ...
            className="p-0 ml-0 w-full sm:w-1/2 md:w-1/3 lg:w-auto"
          >
            <div className="relative w-full mb-10 h-60 md:w-60 md:h-60">
              <img
                src={Avishkar}
                alt="Avishkar"
                className="w-70% h-70% object-cover rounded-lg hover:scale-125 transition duration-300 ease-in-out"
