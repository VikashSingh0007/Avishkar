      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5  mx-auto ">
          <div className="text-center mb-20">
            ...
            <h1 className="w-full text-4xl font-bold mb-10  pt-24 text-center text-gray-900  rumoura-font">
              Accomodation
            </h1>
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <h6 className="leading-relaxed text-black text-lg">
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                <h6 className="text-gray-900 text-xl title-font font-medium mb-3">
                  Price2
                </h6>
                <h6 className="leading-relaxed text-black text-lg">
                  Blue bottle crucifix vinyl post-ironic four dollar toast vegan
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              ...
              <div className="flex-grow">
                ...
                <h6 className="leading-relaxed text-black text-l">
                  Blue bottle crucifix vinyl post-ironic four dollar toast vegan
                  taxidermy. Gastropub indxgo juice poutine, ramps microdosing
                  banh mi pug VHS try-hard.
                </h6>
